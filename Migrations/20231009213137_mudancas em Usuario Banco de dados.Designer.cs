...
namespace ResolverQuestao.Migrations
{
    ...
    [Migration("20231009213137_mudancas em Usuario Banco de dados")]
    partial class mudancasemUsuarioBancodedados
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ResolverQuestao.Models.FeedBack", b =>
                {
            ...
            modelBuilder.Entity("ResolverQuestao.Models.ListaExercicio", b =>
                {
                    ...
                    b.Property<int>("IndiceExercicio")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ResolverQuestao.Models.ListaRegistro", b =>
                {
                    b.Property<int>("ListaRegistroId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasKey("ListaRegistroId");

                    b.HasIndex("ListaExercicioId");

                    b.ToTable("ListaRegistros");
                });

            modelBuilder.Entity("ResolverQuestao.Models.TopicoLista", b =>
                {
                    b.Property<int>("TopicoListaId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasKey("TopicoListaId");

                    b.HasIndex("ListaExercicioId");

                    b.ToTable("TopicoListas");
                });

            modelBuilder.Entity("ResolverQuestao.Models.UsuarioBancoDados", b =>
                {
                    b.Property<int>("UsuarioBancoDadosId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ExerciciosResolvidos")
                        .IsRequired()
                        .HasColumnType("longtext");

                    b.Property<string>("MediaGeral")
                        .IsRequired()
                        .HasColumnType("longtext");

                    b.Property<double>("MetaMedia")
                    ...
                    b.Property<Guid>("UsuarioGuidId")
                        .HasColumnType("char(36)");

                    b.HasKey("UsuarioBancoDadosId");

                    b.ToTable("UsuarioBancoDados");
                });
            ...
            modelBuilder.Entity("ResolverQuestao.Models.FeedBack", b =>
                {
                    b.HasOne("ResolverQuestao.Models.Exercicio", "Exercicio")
                        .WithMany()
                        .HasForeignKey("ExercicioId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ResolverQuestao.Models.ListaRegistro", b =>
                {
                    b.HasOne("ResolverQuestao.Models.ListaExercicio", "ListaExercicio")
                        .WithMany("ListaRegistros")
                        .HasForeignKey("ListaExercicioId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ListaExercicio");
                });

            modelBuilder.Entity("ResolverQuestao.Models.TopicoLista", b =>
                {
                    b.HasOne("ResolverQuestao.Models.ListaExercicio", null)
                        .WithMany("TopicoListas")
                        .HasForeignKey("ListaExercicioId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("ResolverQuestao.Models.ListaExercicio", b =>
                {
                    b.Navigation("ListaRegistros");

                    b.Navigation("TopicoListas");
                });
